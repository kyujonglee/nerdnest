    ...
    <div className="w-full flex justify-center">
      <section className="w-full max-w-6xl pt-24 pb-[60px]">
        ...
        <div className="-mt-[76px] px-7 grid grid-cols-4 gap-5 items-end">
          {/* 메인 보드 스켈레톤 */}
          <div className="border-[#DDDDDD] border-1 rounded-xl p-7 bg-white col-span-2">
          ...
          {[1, 2].map((index) => (
            <div key={index}>
              <div className="bg-[#F8F8F8] border-[#EEEEEE] border-1 rounded-xl px-7 py-6">
                <div className="h-5 bg-gray-200 rounded w-16 animate-pulse"></div>
                <div className="mt-3 space-y-2">
